...
cp -rp /home/centos/roboshell_terraformm/user.service /etc/systemd/system/user.service &>> $LOGFILE
...
cp -rp /home/centos/roboshell_terraformm/mongo.repo /etc/yum.repos.d/mongo.repo &>> $
