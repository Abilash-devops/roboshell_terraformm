...
cp -rp /home/centos/roboshell_terraformm/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
cp -rp /home/centos/roboshell_terraformm/mongo.repo /etc/yum.repos.d/mongo.repo &>>$LOGFILE
